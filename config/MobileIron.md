...
=======
### ForgeRock: Mutual TLS configuration:
>>>>>>> 865ed84fada7c8dfa94841d525ab30ff1f84c012
...
You can choose from a number of different SCEP CA options but for simplicity this document assumes using the OOTB CA included in your Jitsuin subscription (<http://mi.extendedhelp.anyware.com/en/desktop/LocalCertificates.htm>).
...
Earlier you configured the CA, so from Jitsuin Cloud download the root CA:
