 ...
 * @since AM 5.5.0
 */
public class JitsuinPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(JitsuinPlugin.currentVersion,
				Collections.singletonList(Jitsuin.class));
	}
	...
	public String getPluginVersion() {
		return JitsuinPlugin.currentVersion;
	}
}
